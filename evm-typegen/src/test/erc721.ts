...
export class MulticallContract {
  ...
  'balanceOf(address)' = {
    ...
    try: (args: [string, [owner: string]][]): Promise<Result<ethers.BigNumber>[]> => this.try('balanceOf(address)', args)
  }
  ...
  'baseURI()' = {
    ...
    try: (args: string[]): Promise<Result<string>[]> => this.try('baseURI()', args.map((arg) => [arg, []]))
  }
  ...
  'getApproved(uint256)' = {
    ...
    try: (args: [string, [tokenId: ethers.BigNumber]][]): Promise<Result<string>[]> => this.try('getApproved(uint256)', args)
  }
  ...
  'isApprovedForAll(address,address)' = {
    ...
    try: (args: [string, [owner: string, operator: string]][]): Promise<Result<boolean>[]> => this.try('isApprovedForAll(address,address)', args)
  }
  ...
  'ownerOf(uint256)' = {
    ...
    try: (args: [string, [tokenId: ethers.BigNumber]][]): Promise<Result<string>[]> => this.try('ownerOf(uint256)', args)
  }
  ...
  'supportsInterface(bytes4)' = {
    ...
    try: (args: [string, [interfaceId: string]][]): Promise<Result<boolean>[]> => this.try('supportsInterface(bytes4)', args)
  }
  ...
  'tokenByIndex(uint256)' = {
    ...
    try: (args: [string, [index: ethers.BigNumber]][]): Promise<Result<ethers.BigNumber>[]> => this.try('tokenByIndex(uint256)', args)
  }
  ...
  'tokenOfOwnerByIndex(address,uint256)' = {
    ...
    try: (args: [string, [owner: string, index: ethers.BigNumber]][]): Promise<Result<ethers.BigNumber>[]> => this.try('tokenOfOwnerByIndex(address,uint256)', args)
  }
  ...
  'tokenURI(uint256)' = {
    ...
    try: (args: [string, [tokenId: ethers.BigNumber]][]): Promise<Result<string>[]> => this.try('tokenURI(uint256)', args)
  }
