...
// deprecate(address)
export const deprecate = fun('0x0753c30c', {
...
// deprecated()
export const deprecated = viewFun('0x0e136b19', {}, bool)
...
export const addBlackList = fun('0x0ecb93c0', {
    _evilUser: address,
})
...
// upgradedAddress()
export const upgradedAddress = viewFun('0x26976e3f', {}, address)
...
// maximumFee()
export const maximumFee = viewFun('0x35390714', {}, uint256)
...
// _totalSupply()
export const _totalSupply = viewFun('0x3eaaf86b', {}, uint256)
...
// unpause()
export const unpause = fun('0x3f4ba83a', {})
...
export const getBlackListStatus = viewFun('0x59bf1abe', {
    _maker: address,
}, bool)
...
// calcFee(uint256)
export const calcFee = viewFun('0x75dc7d8c', {
    _value: uint256,
}, uint256)
...
export const oldBalanceOf = viewFun('0xb7a3446c', {
    who: address,
}, uint256)
...
export const setParams = fun('0xc0324c77', {
...
// issue(uint256)
export const issue = fun('0xcc872b66', {
    amount: uint256,
})
...
export const increaseApproval = fun('0xd73dd623', {
    _spender: address,
    _addedValue: uint256,
}, bool)
...
// redeem(uint256)
export const redeem = fun('0xdb006a75', {
    amount: uint256,
})
...
// basisPointsRate()
export const basisPointsRate = viewFun('0xdd644f72', {}, uint256)
...
export const isBlackListed = viewFun('0xe47d6060', {
    _0: address,
}, bool)
...
export const removeBlackList = fun('0xe4997dc5', {
...
// MAX_UINT()
export const MAX_UINT = viewFun('0xe5b5019a', {}, uint256)
...
export const transferOwnership = fun('0xf2fde38b', {
    newOwner: address,
})
...
export const destroyBlackFunds = fun('0xf3bdc228', {
