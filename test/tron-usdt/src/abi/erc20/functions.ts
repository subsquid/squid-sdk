...
export const decreaseApproval = func('0x66188463', {
    _spender: address,
...
// calcFee(uint256)
export const calcFee = func('0x75dc7d8c', {
    _value: uint256,
}, uint256)
...
export const oldBalanceOf = func('0xb7a3446c', {
    who: address,
}, uint256)
...
export const increaseApproval = func('0xd73dd623', {
    _spender: address,
    _addedValue: uint256,
}, bool)
