...
export function fromJsonDomainEventKind(json: any): DomainEventKind {
  switch(json?.isTypeOf) {
    ...
    case 'NewOwner': return new NewOwner(undefined, json)
    case 'NewResolver': return new NewResolver(undefined, json)
    case 'NewTTL': return new NewTTL(undefined, json)
    default: throw new TypeError('Unknown json object passed as DomainEventKind')
  }
}
