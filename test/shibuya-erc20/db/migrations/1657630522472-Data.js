module.exports = class Data1657630522472 {
  name = 'Data1657630522472'
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "transfer" ("id" character varying NOT NULL, "value" numeric NOT NULL, "timestamp" numeric NOT NULL, "block" integer NOT NULL, "from_id" character varying, "to_id" character varying, CONSTRAINT "PK_fd9ddbdd49a17afcbe014401295" PRIMARY KEY ("id"))`)
