...
export const MoreAttestations: sts.Type<MoreAttestations> = sts.unit()
...
export const SubId: sts.Type<SubId> = sts.number()
...
export const PhantomData: sts.Type<PhantomData> = sts.unit()
...
export const ProposalIndex: sts.Type<ProposalIndex> = sts.number()
...
export const PropIndex: sts.Type<PropIndex> = sts.number()
...
export const IdentificationTuple: sts.Type<IdentificationTuple> = sts.tuple(() => ValidatorId, FullIdentification)

export type FullIdentification = {
    total: bigint,
    own: bigint,
...
export const AuthorityList: sts.Type<AuthorityList> = sts.array(() => NextAuthority)

export type NextAuthority = [AuthorityId, AuthorityWeight]

export const NextAuthority: sts.Type<NextAuthority> = sts.tuple(() => AuthorityId, AuthorityWeight)

export type AuthorityWeight = bigint

export const AuthorityWeight: sts.Type<AuthorityWeight> = sts.bigint()
...
export const Weight: sts.Type<Weight> = sts.number()
