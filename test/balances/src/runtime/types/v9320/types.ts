...
export type Type_444 = Type_444_Err | Type_444_Ok

export interface Type_444_Err {
    __kind: 'Err'
    value: DispatchErrorWithPostInfo
}

export interface Type_444_Ok {
    __kind: 'Ok'
...
export type Type_60 = Type_60_Err | Type_60_Ok
...
export const Type_60: sts.Type<Type_60> = sts.closedEnum(() => {
    return  {
        Err: DispatchError,
        Ok: sts.unit(),
    }
