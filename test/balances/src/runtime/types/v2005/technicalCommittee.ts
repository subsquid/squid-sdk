 ...
 */
export type TechnicalCommitteeMemberExecutedEvent = [Hash, DispatchResult]

export const TechnicalCommitteeMemberExecutedEvent: sts.Type<TechnicalCommitteeMemberExecutedEvent> = sts.tuple(() => Hash, DispatchResult)

/**
 *  A motion was executed; `bool` is true if returned without error.
 */
export type TechnicalCommitteeExecutedEvent = [Hash, DispatchResult]

export const TechnicalCommitteeExecutedEvent: sts.Type<TechnicalCommitteeExecutedEvent> = sts.tuple(() => Hash, DispatchResult)
