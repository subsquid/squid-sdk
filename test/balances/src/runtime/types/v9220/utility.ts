...
import {Call, OriginCaller, DispatchError} from './types'
 ...
 */
export type UtilityBatchCompletedWithErrorsEvent = null

export const UtilityBatchCompletedWithErrorsEvent: sts.Type<UtilityBatchCompletedWithErrorsEvent> = sts.unit()
