...
import {AccountId32, Call, H256, Type_52} from './types'
 ...
 * # </weight>
 */
export type TechnicalCommitteeDisapproveProposalCall = {
    proposalHash: H256,
}

export const TechnicalCommitteeDisapproveProposalCall: sts.Type<TechnicalCommitteeDisapproveProposalCall> = sts.struct(() => {
    return  {
        proposalHash: H256,
    }
})
 ...
 */
export type TechnicalCommitteeMemberExecutedEvent = [H256, Type_52]

export const TechnicalCommitteeMemberExecutedEvent: sts.Type<TechnicalCommitteeMemberExecutedEvent> = sts.tuple(() => H256, Type_52)

/**
 * A motion was executed; result will be `Ok` if it returned without error.
 * \[proposal_hash, result\]
 */
export type TechnicalCommitteeExecutedEvent = [H256, Type_52]

export const TechnicalCommitteeExecutedEvent: sts.Type<TechnicalCommitteeExecutedEvent> = sts.tuple(() => H256, Type_52)
