...
export type V1DisputeStatementSet = {
...
export const V0ValidatorIndex: sts.Type<V0ValidatorIndex> = sts.number()
...
export type V1CommittedCandidateReceipt = {
...
export type V1CandidateCommitments = {
...
export type V1CandidateDescriptor = {
    paraId: Id,
    relayParent: H256,
    collator: V0Public,
...
export const V0Signature: sts.Type<V0Signature> = sts.bytes()

export type V0Public = Bytes

export const V0Public: sts.Type<V0Public> = sts.bytes()

export type V1UncheckedSigned = {
...
export const V1AvailabilityBitfield: sts.Type<V1AvailabilityBitfield> = sts.uint8array()
...
export const V1Public: sts.Type<V1Public> = sts.bytes()
...
export const V1GroupIndex: sts.Type<V1GroupIndex> = sts.number()

export type V1CoreIndex = number

export const V1CoreIndex: sts.Type<V1CoreIndex> = sts.number()

export type HeadData = Bytes

export const HeadData: sts.Type<HeadData> = sts.bytes()

export type V1CandidateReceipt = {
    descriptor: V1CandidateDescriptor,
...
export type Type_52 = Type_52_Err | Type_52_Ok
