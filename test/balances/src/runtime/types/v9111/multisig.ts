...
import {AccountId32, Timepoint, Call, Type_52} from './types'
 ...
 */
export type MultisigMultisigExecutedEvent = [AccountId32, Timepoint, AccountId32, Bytes, Type_52]

export const MultisigMultisigExecutedEvent: sts.Type<MultisigMultisigExecutedEvent> = sts.tuple(() => AccountId32, Timepoint, AccountId32, sts.bytes(), Type_52)
