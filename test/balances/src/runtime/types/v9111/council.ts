 ...
 */
export type CouncilMemberExecutedEvent = [H256, Type_52]

export const CouncilMemberExecutedEvent: sts.Type<CouncilMemberExecutedEvent> = sts.tuple(() => H256, Type_52)

/**
 * A motion was executed; result will be `Ok` if it returned without error.
 * \[proposal_hash, result\]
 */
export type CouncilExecutedEvent = [H256, Type_52]

export const CouncilExecutedEvent: sts.Type<CouncilExecutedEvent> = sts.tuple(() => H256, Type_52)
