 ...
 */
export type CouncilClosedEvent = [Hash, MemberCount, MemberCount]

export const CouncilClosedEvent: sts.Type<CouncilClosedEvent> = sts.tuple(() => Hash, MemberCount, MemberCount)
