...
export const XcmV2: sts.Type<XcmV2> = sts.array(() => InstructionV2)
...
export type ResponseV2Result = ResponseV2Result_Err | ResponseV2Result_Ok

export interface ResponseV2Result_Err {
    __kind: 'Err'
    value: ResponseV2Error
}
...
export const ResponseV2Result: sts.Type<ResponseV2Result> = sts.closedEnum(() => {
    return  {
        Err: ResponseV2Error,
        Ok: sts.unit(),
    }
...
export const ResponseV2Error: sts.Type<ResponseV2Error> = sts.tuple(() => sts.number(), XcmErrorV2)
...
export const MultiAssetsV2: sts.Type<MultiAssetsV2> = sts.array(() => MultiAssetV1)
...
export const Supports: sts.Type<Supports> = sts.array(() => sts.tuple(() => AccountId, SolutionSupport))
...
export const ExtendedBalance: sts.Type<ExtendedBalance> = sts.bigint()
...
export const OverweightIndex: sts.Type<OverweightIndex> = sts.bigint()
...
export const MessageId: sts.Type<MessageId> = sts.bytes()
