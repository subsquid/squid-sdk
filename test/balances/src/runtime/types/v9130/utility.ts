...
import {OriginCaller, Call, Type_49, DispatchError} from './types'
 ...
 */
export type UtilityDispatchedAsEvent = [Type_49]

export const UtilityDispatchedAsEvent: sts.Type<UtilityDispatchedAsEvent> = sts.tuple(() => Type_49)
