...
export const calls = {
    report_dispute_lost_unsigned: createCall(
        ...
        {
            v9420: v9420.ParasSlashingReportDisputeLostUnsignedCall,
        }
    ),
}
...
export const storage = {
    UnappliedSlashes: createStorage(
        ...
        {
            v9420: v9420.ParasSlashingUnappliedSlashesStorage,
        }
    ),
    ValidatorSetCounts: createStorage(
        'ParasSlashing.ValidatorSetCounts',
        {
            v9420: v9420.ParasSlashingValidatorSetCountsStorage,
        }
    ),
}
