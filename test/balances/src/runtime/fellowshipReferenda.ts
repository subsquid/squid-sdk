...
export const calls = {
    cancel: createCall(
        ...
        {
            v9320: v9320.FellowshipReferendaCancelCall,
        }
    ),
    kill: createCall(
        'FellowshipReferenda.kill',
        {
            v9320: v9320.FellowshipReferendaKillCall,
        }
    ),
    nudge_referendum: createCall(
        'FellowshipReferenda.nudge_referendum',
        {
            v9320: v9320.FellowshipReferendaNudgeReferendumCall,
        }
    ),
    one_fewer_deciding: createCall(
        'FellowshipReferenda.one_fewer_deciding',
        {
            v9320: v9320.FellowshipReferendaOneFewerDecidingCall,
        }
    ),
    place_decision_deposit: createCall(
        'FellowshipReferenda.place_decision_deposit',
        {
            v9320: v9320.FellowshipReferendaPlaceDecisionDepositCall,
        }
    ),
    refund_decision_deposit: createCall(
        'FellowshipReferenda.refund_decision_deposit',
        {
            v9320: v9320.FellowshipReferendaRefundDecisionDepositCall,
        }
    ),
    refund_submission_deposit: createCall(
        'FellowshipReferenda.refund_submission_deposit',
        {
            v9350: v9350.FellowshipReferendaRefundSubmissionDepositCall,
        }
    ),
    set_metadata: createCall(
        'FellowshipReferenda.set_metadata',
        {
            v9420: v9420.FellowshipReferendaSetMetadataCall,
        }
    ),
    submit: createCall(
        'FellowshipReferenda.submit',
        {
            v9320: v9320.FellowshipReferendaSubmitCall,
            v9370: v9370.FellowshipReferendaSubmitCall,
            v9381: v9381.FellowshipReferendaSubmitCall,
            v9420: v9420.FellowshipReferendaSubmitCall,
        }
    ),
}
...
export const constants = {
    AlarmInterval: createConstant(
        ...
        {
            v9320: v9320.FellowshipReferendaAlarmIntervalConstant,
        }
    ),
    MaxQueued: createConstant(
        'FellowshipReferenda.MaxQueued',
        {
            v9320: v9320.FellowshipReferendaMaxQueuedConstant,
        }
    ),
    SubmissionDeposit: createConstant(
        'FellowshipReferenda.SubmissionDeposit',
        {
            v9320: v9320.FellowshipReferendaSubmissionDepositConstant,
        }
    ),
    Tracks: createConstant(
        'FellowshipReferenda.Tracks',
        {
            v9320: v9320.FellowshipReferendaTracksConstant,
        }
    ),
    UndecidingTimeout: createConstant(
        'FellowshipReferenda.UndecidingTimeout',
        {
            v9320: v9320.FellowshipReferendaUndecidingTimeoutConstant,
        }
    ),
}
...
export const storage = {
    DecidingCount: createStorage(
        ...
        {
            v9320: v9320.FellowshipReferendaDecidingCountStorage,
        }
    ),
    MetadataOf: createStorage(
        'FellowshipReferenda.MetadataOf',
        {
            v9420: v9420.FellowshipReferendaMetadataOfStorage,
        }
    ),
    ReferendumCount: createStorage(
        'FellowshipReferenda.ReferendumCount',
        {
            v9320: v9320.FellowshipReferendaReferendumCountStorage,
        }
    ),
    ReferendumInfoFor: createStorage(
        'FellowshipReferenda.ReferendumInfoFor',
        {
            v9320: v9320.FellowshipReferendaReferendumInfoForStorage,
            v9350: v9350.FellowshipReferendaReferendumInfoForStorage,
            v9370: v9370.FellowshipReferendaReferendumInfoForStorage,
            v9381: v9381.FellowshipReferendaReferendumInfoForStorage,
            v9420: v9420.FellowshipReferendaReferendumInfoForStorage,
        }
    ),
    TrackQueue: createStorage(
        'FellowshipReferenda.TrackQueue',
        {
            v9320: v9320.FellowshipReferendaTrackQueueStorage,
        }
    ),
}
