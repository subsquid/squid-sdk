...
export const events = {
    Added: createEvent(
        'ChildBounties.Added',
        {
            v9190: v9190.ChildBountiesAddedEvent,
        }
    ),
    Awarded: createEvent(
        'ChildBounties.Awarded',
        {
            v9190: v9190.ChildBountiesAwardedEvent,
        }
    ),
    Canceled: createEvent(
        'ChildBounties.Canceled',
        {
            v9190: v9190.ChildBountiesCanceledEvent,
        }
    ),
    Claimed: createEvent(
        'ChildBounties.Claimed',
        {
            v9190: v9190.ChildBountiesClaimedEvent,
        }
    ),
}
...
export const constants = {
    ChildBountyValueMinimum: createConstant(
        ...
        {
            v9190: v9190.ChildBountiesChildBountyValueMinimumConstant,
        }
    ),
    MaxActiveChildBountyCount: createConstant(
        'ChildBounties.MaxActiveChildBountyCount',
        {
            v9190: v9190.ChildBountiesMaxActiveChildBountyCountConstant,
        }
    ),
}
