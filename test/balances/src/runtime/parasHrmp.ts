...
export const events = {
    ChannelClosed: createEvent(
        ...
        {
            v9010: v9010.ParasHrmpChannelClosedEvent,
        }
    ),
    OpenChannelAccepted: createEvent(
        'ParasHrmp.OpenChannelAccepted',
        {
            v9010: v9010.ParasHrmpOpenChannelAcceptedEvent,
        }
    ),
    OpenChannelRequested: createEvent(
        'ParasHrmp.OpenChannelRequested',
        {
            v9010: v9010.ParasHrmpOpenChannelRequestedEvent,
        }
    ),
}
