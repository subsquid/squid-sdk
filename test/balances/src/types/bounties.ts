...
export const events = {
    BountyAwarded: createEvent(
        ...
        {
            v2028: BountiesBountyAwardedEvent,
            v9130: BountiesBountyAwardedEvent,
        }
    ),
    BountyBecameActive: createEvent(
        'Bounties.BountyBecameActive',
        {
            v2028: BountiesBountyBecameActiveEvent,
            v9130: BountiesBountyBecameActiveEvent,
        }
    ),
    BountyCanceled: createEvent(
        'Bounties.BountyCanceled',
        {
            v2028: BountiesBountyCanceledEvent,
            v9130: BountiesBountyCanceledEvent,
        }
    ),
    BountyClaimed: createEvent(
        'Bounties.BountyClaimed',
        {
            v2028: BountiesBountyClaimedEvent,
            v9130: BountiesBountyClaimedEvent,
        }
    ),
    BountyExtended: createEvent(
        'Bounties.BountyExtended',
        {
            v2028: BountiesBountyExtendedEvent,
            v9130: BountiesBountyExtendedEvent,
        }
    ),
    BountyProposed: createEvent(
        'Bounties.BountyProposed',
        {
            v2028: BountiesBountyProposedEvent,
            v9130: BountiesBountyProposedEvent,
        }
    ),
    BountyRejected: createEvent(
        'Bounties.BountyRejected',
        {
            v2028: BountiesBountyRejectedEvent,
            v9130: BountiesBountyRejectedEvent,
        }
    ),
}
...
export const calls = {
    accept_curator: createCall(
        ...
        {
            v2028: BountiesAcceptCuratorCall,
            v9111: BountiesAcceptCuratorCall,
        }
    ),
    approve_bounty: createCall(
        'Bounties.approve_bounty',
        {
            v2028: BountiesApproveBountyCall,
            v9111: BountiesApproveBountyCall,
        }
    ),
    award_bounty: createCall(
        'Bounties.award_bounty',
        {
            v2028: BountiesAwardBountyCall,
            v9111: BountiesAwardBountyCall,
        }
    ),
    claim_bounty: createCall(
        'Bounties.claim_bounty',
        {
            v2028: BountiesClaimBountyCall,
            v9111: BountiesClaimBountyCall,
        }
    ),
    close_bounty: createCall(
        'Bounties.close_bounty',
        {
            v2028: BountiesCloseBountyCall,
            v9111: BountiesCloseBountyCall,
        }
    ),
    extend_bounty_expiry: createCall(
        'Bounties.extend_bounty_expiry',
        {
            v2028: BountiesExtendBountyExpiryCall,
            v9111: BountiesExtendBountyExpiryCall,
        }
    ),
    propose_bounty: createCall(
        'Bounties.propose_bounty',
        {
            v2028: BountiesProposeBountyCall,
        }
    ),
    propose_curator: createCall(
        'Bounties.propose_curator',
        {
            v2028: BountiesProposeCuratorCall,
            v9111: BountiesProposeCuratorCall,
        }
    ),
    unassign_curator: createCall(
        'Bounties.unassign_curator',
        {
            v2028: BountiesUnassignCuratorCall,
            v9111: BountiesUnassignCuratorCall,
        }
    ),
}
...
export const storage = {
    Bounties: createStorage(
        'Bounties.Bounties',
        {
            v2028: BountiesBountiesStorage,
            v9111: BountiesBountiesStorage,
        }
    ),
    BountyApprovals: createStorage(
        'Bounties.BountyApprovals',
        {
            v2028: BountiesBountyApprovalsStorage,
        }
    ),
    BountyCount: createStorage(
        'Bounties.BountyCount',
        {
            v2028: BountiesBountyCountStorage,
        }
    ),
    BountyDescriptions: createStorage(
        'Bounties.BountyDescriptions',
        {
            v2028: BountiesBountyDescriptionsStorage,
        }
    ),
}
