...
export const events = {
    CandidateSlashed: createEvent(
        ...
        {
            v9010: PhragmenElectionCandidateSlashedEvent,
            v9130: PhragmenElectionCandidateSlashedEvent,
        }
    ),
    ElectionError: createEvent(
        'PhragmenElection.ElectionError',
        {
            v9010: PhragmenElectionElectionErrorEvent,
        }
    ),
    EmptyTerm: createEvent(
        'PhragmenElection.EmptyTerm',
        {
            v9010: PhragmenElectionEmptyTermEvent,
        }
    ),
    MemberKicked: createEvent(
        'PhragmenElection.MemberKicked',
        {
            v9010: PhragmenElectionMemberKickedEvent,
            v9130: PhragmenElectionMemberKickedEvent,
        }
    ),
    NewTerm: createEvent(
        'PhragmenElection.NewTerm',
        {
            v9010: PhragmenElectionNewTermEvent,
            v9130: PhragmenElectionNewTermEvent,
        }
    ),
    Renounced: createEvent(
        'PhragmenElection.Renounced',
        {
            v9010: PhragmenElectionRenouncedEvent,
            v9130: PhragmenElectionRenouncedEvent,
        }
    ),
    SeatHolderSlashed: createEvent(
        'PhragmenElection.SeatHolderSlashed',
        {
            v9010: PhragmenElectionSeatHolderSlashedEvent,
            v9130: PhragmenElectionSeatHolderSlashedEvent,
        }
    ),
}
...
export const calls = {
    clean_defunct_voters: createCall(
        ...
        {
            v9010: PhragmenElectionCleanDefunctVotersCall,
            v9111: PhragmenElectionCleanDefunctVotersCall,
        }
    ),
    remove_member: createCall(
        'PhragmenElection.remove_member',
        {
            v9010: PhragmenElectionRemoveMemberCall,
            v9111: PhragmenElectionRemoveMemberCall,
            v9271: PhragmenElectionRemoveMemberCall,
        }
    ),
    remove_voter: createCall(
        'PhragmenElection.remove_voter',
        {
            v9010: PhragmenElectionRemoveVoterCall,
        }
    ),
    renounce_candidacy: createCall(
        'PhragmenElection.renounce_candidacy',
        {
            v9010: PhragmenElectionRenounceCandidacyCall,
        }
    ),
    submit_candidacy: createCall(
        'PhragmenElection.submit_candidacy',
        {
            v9010: PhragmenElectionSubmitCandidacyCall,
            v9111: PhragmenElectionSubmitCandidacyCall,
        }
    ),
    vote: createCall(
        'PhragmenElection.vote',
        {
            v9010: PhragmenElectionVoteCall,
        }
    ),
}
