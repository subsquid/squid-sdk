...
export const calls = {
    clean_defunct_voters: createCall(
        ...
        {
            v2028: ElectionsPhragmenCleanDefunctVotersCall,
        }
    ),
    remove_member: createCall(
        'ElectionsPhragmen.remove_member',
        {
            v1020: ElectionsPhragmenRemoveMemberCall,
            v1050: ElectionsPhragmenRemoveMemberCall,
            v2005: ElectionsPhragmenRemoveMemberCall,
            v2028: ElectionsPhragmenRemoveMemberCall,
        }
    ),
    remove_voter: createCall(
        'ElectionsPhragmen.remove_voter',
        {
            v1020: ElectionsPhragmenRemoveVoterCall,
        }
    ),
    renounce_candidacy: createCall(
        'ElectionsPhragmen.renounce_candidacy',
        {
            v1020: ElectionsPhragmenRenounceCandidacyCall,
            v2005: ElectionsPhragmenRenounceCandidacyCall,
        }
    ),
    report_defunct_voter: createCall(
        'ElectionsPhragmen.report_defunct_voter',
        {
            v1020: ElectionsPhragmenReportDefunctVoterCall,
            v1050: ElectionsPhragmenReportDefunctVoterCall,
            v2005: ElectionsPhragmenReportDefunctVoterCall,
        }
    ),
    submit_candidacy: createCall(
        'ElectionsPhragmen.submit_candidacy',
        {
            v1020: ElectionsPhragmenSubmitCandidacyCall,
            v2005: ElectionsPhragmenSubmitCandidacyCall,
        }
    ),
    vote: createCall(
        'ElectionsPhragmen.vote',
        {
            v1020: ElectionsPhragmenVoteCall,
        }
    ),
}
...
export const storage = {
    Candidates: createStorage(
        ...
        {
            v1020: ElectionsPhragmenCandidatesStorage,
            v2028: ElectionsPhragmenCandidatesStorage,
        }
    ),
    ElectionRounds: createStorage(
        'ElectionsPhragmen.ElectionRounds',
        {
            v1020: ElectionsPhragmenElectionRoundsStorage,
        }
    ),
    Members: createStorage(
        'ElectionsPhragmen.Members',
        {
            v1020: ElectionsPhragmenMembersStorage,
            v2028: ElectionsPhragmenMembersStorage,
        }
    ),
    RunnersUp: createStorage(
        'ElectionsPhragmen.RunnersUp',
        {
            v1020: ElectionsPhragmenRunnersUpStorage,
            v2028: ElectionsPhragmenRunnersUpStorage,
        }
    ),
    StakeOf: createStorage(
        'ElectionsPhragmen.StakeOf',
        {
            v1020: ElectionsPhragmenStakeOfStorage,
        }
    ),
    VotesOf: createStorage(
        'ElectionsPhragmen.VotesOf',
        {
            v1020: ElectionsPhragmenVotesOfStorage,
        }
    ),
    Voting: createStorage(
        'ElectionsPhragmen.Voting',
        {
            v1058: ElectionsPhragmenVotingStorage,
            v2028: ElectionsPhragmenVotingStorage,
        }
    ),
}
