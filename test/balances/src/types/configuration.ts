...
export const storage = {
    ActiveConfig: createStorage(
        ...
        {
            v9090: ConfigurationActiveConfigStorage,
            v9111: ConfigurationActiveConfigStorage,
            v9160: ConfigurationActiveConfigStorage,
            v9291: ConfigurationActiveConfigStorage,
            v9320: ConfigurationActiveConfigStorage,
            v9370: ConfigurationActiveConfigStorage,
            v9420: ConfigurationActiveConfigStorage,
            v9430: ConfigurationActiveConfigStorage,
        }
    ),
    BypassConsistencyCheck: createStorage(
        'Configuration.BypassConsistencyCheck',
        {
            v9160: ConfigurationBypassConsistencyCheckStorage,
        }
    ),
    PendingConfig: createStorage(
        'Configuration.PendingConfig',
        {
            v9090: ConfigurationPendingConfigStorage,
            v9111: ConfigurationPendingConfigStorage,
        }
    ),
    PendingConfigs: createStorage(
        'Configuration.PendingConfigs',
        {
            v9160: ConfigurationPendingConfigsStorage,
            v9291: ConfigurationPendingConfigsStorage,
            v9320: ConfigurationPendingConfigsStorage,
            v9370: ConfigurationPendingConfigsStorage,
            v9420: ConfigurationPendingConfigsStorage,
            v9430: ConfigurationPendingConfigsStorage,
        }
    ),
}
