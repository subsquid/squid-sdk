...
export const calls = {
    add_trusted_validation_code: createCall(
        ...
        {
            v9160: ParasAddTrustedValidationCodeCall,
        }
    ),
    force_note_new_head: createCall(
        'Paras.force_note_new_head',
        {
            v9010: ParasForceNoteNewHeadCall,
            v9111: ParasForceNoteNewHeadCall,
        }
    ),
    force_queue_action: createCall(
        'Paras.force_queue_action',
        {
            v9010: ParasForceQueueActionCall,
        }
    ),
    force_schedule_code_upgrade: createCall(
        'Paras.force_schedule_code_upgrade',
        {
            v9010: ParasForceScheduleCodeUpgradeCall,
            v9090: ParasForceScheduleCodeUpgradeCall,
            v9111: ParasForceScheduleCodeUpgradeCall,
        }
    ),
    force_set_current_code: createCall(
        'Paras.force_set_current_code',
        {
            v9010: ParasForceSetCurrentCodeCall,
            v9111: ParasForceSetCurrentCodeCall,
        }
    ),
    force_set_current_head: createCall(
        'Paras.force_set_current_head',
        {
            v9010: ParasForceSetCurrentHeadCall,
            v9111: ParasForceSetCurrentHeadCall,
        }
    ),
    include_pvf_check_statement: createCall(
        'Paras.include_pvf_check_statement',
        {
            v9160: ParasIncludePvfCheckStatementCall,
        }
    ),
    poke_unused_validation_code: createCall(
        'Paras.poke_unused_validation_code',
        {
            v9160: ParasPokeUnusedValidationCodeCall,
        }
    ),
}
...
export const constants = {
    UnsignedPriority: createConstant(
        ...
        {
            v9160: ParasUnsignedPriorityConstant,
        }
    ),
}
