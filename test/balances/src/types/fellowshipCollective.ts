...
export const events = {
    MemberAdded: createEvent(
        ...
        {
            v9320: FellowshipCollectiveMemberAddedEvent,
        }
    ),
    MemberRemoved: createEvent(
        'FellowshipCollective.MemberRemoved',
        {
            v9320: FellowshipCollectiveMemberRemovedEvent,
        }
    ),
    RankChanged: createEvent(
        'FellowshipCollective.RankChanged',
        {
            v9320: FellowshipCollectiveRankChangedEvent,
        }
    ),
    Voted: createEvent(
        'FellowshipCollective.Voted',
        {
            v9320: FellowshipCollectiveVotedEvent,
        }
    ),
}
