...
export const events = {
    Rebagged: createEvent(
        'VoterList.Rebagged',
        {
            v9230: VoterListRebaggedEvent,
        }
    ),
    ScoreUpdated: createEvent(
        'VoterList.ScoreUpdated',
        {
            v9230: VoterListScoreUpdatedEvent,
        }
    ),
}
...
export const calls = {
    put_in_front_of: createCall(
        ...
        {
            v9230: VoterListPutInFrontOfCall,
            v9291: VoterListPutInFrontOfCall,
        }
    ),
    rebag: createCall(
        'VoterList.rebag',
        {
            v9230: VoterListRebagCall,
            v9291: VoterListRebagCall,
        }
    ),
}
...
export const constants = {
    BagThresholds: createConstant(
        ...
        {
            v9230: VoterListBagThresholdsConstant,
        }
    ),
}
...
export const storage = {
    CounterForListNodes: createStorage(
        ...
        {
            v9230: VoterListCounterForListNodesStorage,
        }
    ),
    ListBags: createStorage(
        'VoterList.ListBags',
        {
            v9230: VoterListListBagsStorage,
        }
    ),
    ListNodes: createStorage(
        'VoterList.ListNodes',
        {
            v9230: VoterListListNodesStorage,
        }
    ),
}
