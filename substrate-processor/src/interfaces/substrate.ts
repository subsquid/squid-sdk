 ...
 * 
 * The `specName` field is a string, defining the name of a Runtime spec
 * 
 * The `specVersion` property is a {@link SpecVersion} object, defining the version number of a Runtime spec
 */
