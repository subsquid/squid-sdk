...
export class SubstrateProcessor {
    ...
    /**
     * Adds a {@link BlockHandler} function that is executed before processing each block. Can accept an additional 
    ...
    /**
     * Adds a {@link BlockHandler} function that is executed before processing each block.
     *
    ...
    /**
     * Adds a {@link BlockHandler} function that is executed after processing each block. Can accept an 
    ...
    /**
     * Adds a {@link BlockHandler} function that is executed after processing each block.
     *
     * @param options an object corresponding to the {@link BlockHookOptions} interface, setting the {@link Range} of 
     * execution for the `fn` function
     * @param fn an asynchronous function that implements the {@link BlockHandler} interface, by accepting a 
    ...
    /**
     * Adds an {@link EventHandler} function that is executed when an Event with the specified name is 
     * encountered. Can accept an additional {@link EventHandlerOptions} parameter.
     * 
     * @param eventName a {@link QualifiedName} (a string), representing the name of the Event of interest, in the form 
     * `${module}.${Name}`. When such Event is encountered, the provided function is executed.
    ...
    /**
     * Adds an {@link ExtrinsicHandler} function that is executed when an Event with the specified name is 
     * encountered. Can accept an additional {@link ExtrinsicHandlerOptions} parameter.
     * 
     * @param extrinsicName a {@link QualifiedName} (a string), representing the name of the Event of interest, in the form 
     * `${section}.${method}`. When such Event is encountered, the provided function is executed.
   ...
   * triggered in the canonical order defined by the ordering of the events in the block.
   * 
