...
describe('resolvers extension', function () {
    useDatabase([
        ...
        `insert into scalar (id, bool, date, big_int, big_decimal, "bytes", attributes) values ('1', true, '2021-09-24T00:00:00.000Z', 1000000000000000, 0.0000000000015, decode('aa', 'hex'), '[1, 2, 3]'::jsonb)`,
